...
async def connect_to_mongodb() -> None:
    """Create shared MongoDB client with connection pool."""
    ...
    try:
        ...
        print("This is usually because your current public IP address is not whitelisted")
        print("in your MongoDB Atlas console.")
        print("To fix this:")
        print("1. Log in to https://cloud.mongodb.com/")
        print("2. Navigate to Security -> Network Access")
        print("3. Click 'Add IP Address' and choose 'Allow Access From Anywhere' (or add current IP)")
        print("=" * 80 + "\n")
        raise
